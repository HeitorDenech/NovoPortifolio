        ...
        <section className='home'>
            ...
            <div className='container-introducao'>
                <div className='container-interno-introducao'>
                    <h1 data-aos="fade-right">Web designer</h1>
                    <p data-aos="fade-right">Olá! me chamo <a href="https://www.youtube.com/watch?v=EOA1wBw_Jt4" target='_blank'>H</a>eitor Denech, sou apaixonado por transformar ideias em experiências visuais criativas e funcionais. Através do design responsivo,
            ...
            <div className='container-img'>
                <img data-aos="fade-left" src={programador} alt="" />
            </div>
